//Exemplo 02 - Salvar tema do aplicativo
...
class _MyAppState extends State<TemaApp> {
  ...
  Future<void> salvarTema(bool valor) async {
    ...
    // Salva o tema (true para escuro, false para claro)
  ...
  Future<void> carregarTema() async {
    ...
    // Verifica se existe um valor salvo para o tema
    bool? temaSalvo = prefs.getBool('temaEscuro');

    // Se existir, atualiza a variável isDarkTheme
    setState(() {
